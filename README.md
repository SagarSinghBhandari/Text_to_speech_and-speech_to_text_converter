This mini-project is a Speech Converter application built using the Tkinter library in Python. It allows users to convert text to speech and speech to text.
